    ...
    traingTest = [
      TraingTest(questWord: a.words[indeks][0]['word'].toString(), answers: [
        ...
        Answer(
            ...
            isRight: false),
        Answer(
            t_answer: a.words[0 + 3][3]['translation'].toString(),
            isRight: false),
        Answer(
            t_answer: a.words[0 + 4][1]['translation'].toString(),
            isRight: false),
      ]),
      TraingTest(questWord: a.words[indeks][1]['word'].toString(), answers: [
        ...
        Answer(
            ...
            isRight: true),
        Answer(
            t_answer: a.words[4][2]['translation'].toString(), isRight: false),
        Answer(
      ...
      TraingTest(questWord: a.words[indeks][2]['word'].toString(), answers: [
        Answer(
            t_answer: a.words[1][1]['translation'].toString(), isRight: false),
        Answer(
            t_answer: a.words[7][4]['translation'].toString(), isRight: false),
        Answer(
            t_answer: a.words[8][3]['translation'].toString(), isRight: false),
        Answer(
